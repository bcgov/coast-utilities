...
namespace CASInterfaceService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            Console.WriteLine("------------------------------------------------------------------");
            Console.WriteLine(JsonSerializer.Serialize(Configuration.GetSection("ReverseProxy").AsEnumerable(makePathsRelative: true).Where(x => x.Value != null).ToDictionary(x => x.Key, x => x.Value)));
            Console.WriteLine("------------------------------------------------------------------");
