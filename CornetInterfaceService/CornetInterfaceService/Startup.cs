        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddTransforms(builderContext =>
                {
                    ...
                    {
                        Console.WriteLine($"YARP BEFORE - Proxying to: {transformContext.ProxyRequest.RequestUri}");
                        foreach (var header in transformContext.ProxyRequest.Headers)
                        {
                            Console.WriteLine($"YARP BEFORE - Header: {header.Key}: {string.Join(", ", header.Value)}");
                        }
                        ...
                        Console.WriteLine($"YARP AFTER - Proxying to: {transformContext.ProxyRequest.RequestUri}");
                        foreach (var header in transformContext.ProxyRequest.Headers)
                        {
                            Console.WriteLine($"YARP AFTER - Header: {header.Key}: {string.Join(", ", header.Value)}");
                        }
